(function() {
    ...
    var oc = function() {
        ...
        ge = function(a, b, c) {
            1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j55", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"),
            ua))
        };
    var h = function(a) {
        ...
        bd = function(a, b, c) {
            if (!ad) {
                ...
                if (e = (d = (d = d && d.match(g) || e && e.match(g)) ? d[1] : Ca("GASO")[0] || "") && d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))
                    zc("GASO", "" + d, c, b, a, 0), window._udo || (window._udo = b), window._utcp || (window._utcp = c), a = e[1], wa("https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&" : "") + hd(), "_gasojs");
                ad = !0
            }
        };
    var H = function(a) {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function(a, b) {
            ...
            if ("cookie" == P(a, ac)) {
                ...
                c && (a.data.set(Q, c), c = Ca(P(a, la)),
                (c = na(a, c)) && a.data.set(I, c), hc = !0)
            }
            a:
            if (c = a.get(cc), c = E(M.location[c ? "href" : "search"], "_ga"))
                if (a.get(bc))
                    if (d = c.indexOf("."), -1 == d)
                        J(22);
                    else {
                        var e = c.substring(0, d),
                            ...
                            g = g.substring(d + 1);
                        if ("1" == e) {
                            if (d = g, c != Ic(d, 0) && c != Ic(d, -1) && c != Ic(d, -2) && c != pa(d, 0) && c != pa(d, -1) && c != pa(d, -2)) {
                                J(23);
                                break a
                            }
                        } else if ("2" == e) {
                            e = g.split("-", 2);
                            d = e[1];
                            if (c != Ic(e[0] + d, 0) && c != Ic(e[0] + d, -1) && c != Ic(e[0] + d, -2) && c != pa(e[0] + d, 0) && c != pa(e[0] + d, -1) && c != pa(e[0] + d, -2)) {
                                J(53);
                                break a
                            }
                            J(2);
